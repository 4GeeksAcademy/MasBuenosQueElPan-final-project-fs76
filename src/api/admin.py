...
from .models import db, User, Producer, ProductCategories, Product, CartItem, CartProduct, CustomerCart, Customer, ProducerOrders
...
def setup_admin(app):
    ...
    admin.add_view(ModelView(ProducerOrders, db.session))
