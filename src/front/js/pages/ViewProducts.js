...
//                                 const categorie = store.categories.find(cat => cat.name === product.categorie);
//                                 const imageUrl = categorie ? categorie.url : "Imagen de producto.jpg"; // Imagen por defecto si no hay categoría
...
//                                             <button className="btn btn-info" type="button" onClick={() => openModal(product.id)}>
//                                                 Editar
//                                             </button>
//                                             <button className="btn btn-danger" type="button" onClick={() => actions.deleteProduct(product.id)}>
//                                                 Eliminar
//                                             </button>
//                                         </div>
//                                     </div>
...
//                         <div className="card col-4" key={index} style={{"width": "18rem"}}>
//                             <img 
//                                 src={store.categories.url || "Imagen de producto.jpg"}   // Si no hay URL, puedes mostrar una imagen de placeholder
//                                 alt="imagen de producto"
//                                 // style={{ width: '50px', height: '50px' }}
//                             />
//                         {/* <img src={rigoImageUrl} className="card-img-top" alt="..."/> */}
//                         {/* {store.categoriesWithUrls?.map((categorie, index) => (
//                             <li key={index}>
//                                 <img 
//                                     src={categorie.url || "Imagen de producto.jpg"}  // Si no hay URL, puedes mostrar una imagen de placeholder
//                                     alt={categorie.name}
//                                     style={{ width: '50px', height: '50px' }}
//                                 />
//                                 {categorie.name}  {/* Muestra el nombre de la categoría */}
//                             {/* </li>
//                         ))} */} 
//                             {/* <div className="card-body">
//                                 <h5 className="card-title" >{product.name}</h5>
