...
export const ProducerInfoForm = () => {
    ...
    //         }
    //     } else {
    //         // Initialize with empty values for adding a new producer
    //         setProducerInfo({
    //             email: '',
    //             brand_name: '',
    //             user_name: '',
    ...
    //         });
    //     }
    // }, [store.producers, producerId, isEditMode]);
    ...
    //         actions.editProducer(producerId, producerInfo);
    //     // } else {
    //     //     actions.addProducer(producerInfo);
    //     }
    //     setShowSuccessMessage(true);
    //     setTimeout(() => {
    ...
    return (
        ...
        {showSuccessMessage &&
        <div className="alert alert-success">Info added succsesfully. Redirecting to Homepage!
